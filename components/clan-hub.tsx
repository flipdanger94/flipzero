...
type Clan={
  ...
  joinType:JoinType;memberCount:number;leaderId:string;createdAt:string;xp:number;level?:number;tagColor:string;tagIcon:string;
};
type DiscoveryClan=Clan&{full:boolean;pendingRequest:{id:string;kind:"application"|"invite";status:string}|null};
type Member={userId:string;username:string;displayName:string;avatarUrl:string|null;presence:string;globalLevel:number;globalXp:number;contributionXp:number;role:ClanRole;joinedAt:string};
