...
export default function Home({ initialSpaceId, initialChannelId }: { initialSpaceId?: string; initialChannelId?: string } = {}) {
  ...
  const canModerate = Boolean(activeSpace && (isSpaceOwner || hasPermission(spacePermissions, Permission.ModerateMembers) || hasPermission(spacePermissions, Permission.BanMembers)));
