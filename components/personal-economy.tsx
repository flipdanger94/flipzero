...
export function PersonalEconomy({onOpenSuperFlip}:{onOpenSuperFlip?:()=>void}={}){
  ...
  return <div className="personal-economy store-shell">
    <header className="store-shell-head">
      ...
      <strong><Coins size={22}/>{balance.toLocaleString("ru-RU")} <small>монет</small></strong>
    </header>
    ...
    {!loading&&tab==="quests"?<div className="quests-page">
      <div className="personal-streak"><Gift size={22}/><span><strong>Серия: {streak} дн.</strong><small>Зарабатывайте монет и открывайте новые предметы.</small></span></div>
