...
type Pref={theme:string;dndEnabled:boolean;dndDays:number[];dndStart:string;dndEnd:string;dndTimezone:string;dndFavoriteIds:string[];dndClanException:boolean};
...
function applyPreview(value:Pref,themes:Theme[]){
 ...
 if(theme.appBackground){
  ...
  root.style.setProperty("--theme-border",`color-mix(in srgb, ${theme.accent} 22%, transparent)`);
