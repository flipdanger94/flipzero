  ...
  return (
    <main className="auth-page">
      <section className="auth-story">
        <Link href="/" className="auth-brand" aria-label="FlipZero"><span>FZ</span><strong>FlipZero</strong></Link>
