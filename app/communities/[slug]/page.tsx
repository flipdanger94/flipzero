...
export default async function CommunityPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const firstChannel = channelRows[0] ?? null;
  ...
  return <main className="community-page">
    ...
    <section className="community-hero" style={{ "--community-accent": space.accentColor } as React.CSSProperties}>
      ...
      <div className="community-content">
        ...
        <CommunityActions spaceId={space.id} slug={space.slug} channelId={firstChannel?.id ?? null} isMember={isMember} isAuthenticated={Boolean(user)} />
      </div>
    </section>
