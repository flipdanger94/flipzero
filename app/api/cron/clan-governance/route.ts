...
import { clanEventRsvps, clanEvents, mediaAssets, notifications, temporaryVoiceRooms, userStories } from "@/db/schema";
...
export async function GET(request:Request){
 ...
 await db.delete(temporaryVoiceRooms).where(lt(temporaryVoiceRooms.expiresAt,now));
