...
const releases: Record<string, { migrationUrl: URL; title: string; check: string }> = {
  ...
  "release-0016": { migrationUrl: new URL("../../../../drizzle/0015_role_member_badges.sql", import.meta.url), title: "Роли в списке участников", check: "SELECT EXISTS(SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='roles' AND column_name='show_in_member_list') AS applied" },
};
