...
export function proxy(request: NextRequest) {
  const livekitWebhook = request.nextUrl.pathname === "/api/livekit/webhook";
  if (request.nextUrl.pathname.startsWith("/api/") && !livekitWebhook && !["GET", "HEAD", "OPTIONS"].includes(request.method)) {
